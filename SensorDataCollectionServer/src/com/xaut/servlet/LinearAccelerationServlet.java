...
import com.xaut.daoimpl.LinearAccelerationDaoImpl;

@SuppressWarnings("serial")
public class LinearAccelerationServlet extends HttpServlet{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		LinearAccelerationDao dao = new LinearAccelerationDaoImpl();
