...
import com.xaut.entity.Temperature;
...
SensorEventListener{
	...
	private ArrayList<Temperature> list = new ArrayList<Temperature>();
...
//		setRetainInstance(true);
	...
	//	Relativelayout.setBackgroundResource(R.drawable.leaf);
		...
		temshow = (TextView) view.findViewById(R.id.show);

		if (temperature != null) {

			temshow.setText("名称：" + temperature.getName() + "\n\n版本："
					+ temperature.getVersion() + "\n\n供应商："
					+ temperature.getVendor() + "\n\n功率："
					+ temperature.getPower() + "\n\n分辨率："
					+ temperature.getResolution() + "\n\n最大范围："
					+ temperature.getMaximumRange() + "\n");
	...
	public void onResume() {
		...
		sensor.registerListener(this, temperature, 500000);
	}
	...
	public void onSensorChanged(SensorEvent event) {
		...
		if (flag == 1) {
			...
			temshow.setText("环境温度传感器数据：\n\n环境温度：" + Double.parseDouble(df.format(x)) + "℃\n");
...
//			}	
	   ...
	   private String sample(double x){
			...
			String url = httpUtil.BASE_URL + "/TemperatureServlet";
	...
	private void initView() {
		...
		mRenderer.setYTitle("数据(℃)");// 设置y轴的标题
