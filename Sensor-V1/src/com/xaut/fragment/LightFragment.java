...
import com.xaut.entity.Light;
import com.xaut.sensor_v1.R;
import com.xaut.util.httpUtil;

public class LightFragment extends Fragment implements
SensorEventListener {
	...
	private ArrayList<Light> list = new ArrayList<Light>();
...
//		setRetainInstance(true);
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		// 获取环境光线传感器实例
		light = sensor.getDefaultSensor(Sensor.TYPE_LIGHT);
	...
	//	Relativelayout.setBackgroundResource(R.drawable.leaf);
		...
		ligshow = (TextView) view.findViewById(R.id.show);

		if (light != null) {

			ligshow.setText("名称：" + light.getName() + "\n\n版本："
					+ light.getVersion() + "\n\n供应商："
					+ light.getVendor() + "\n\n功率："
					+ light.getPower() + "\n\n分辨率："
					+ light.getResolution() + "\n\n最大范围："
	...
	public void onResume() {
		...
		sensor.registerListener(this, light, 500000);
	}
...
//			}	
	   ...
	   private String sample(double x){
			...
			String url = httpUtil.BASE_URL + "/LightServlet";
	...
	private void initView() {
		...
		mRenderer.setYTitle("数据(lx)");// 设置y轴的标题
