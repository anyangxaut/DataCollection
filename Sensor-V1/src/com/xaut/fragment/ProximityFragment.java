...
import com.xaut.entity.Proximity;
import com.xaut.sensor_v1.R;
import com.xaut.util.httpUtil;

public class ProximityFragment extends Fragment implements
SensorEventListener{
	...
	private ArrayList<Proximity> list = new ArrayList<Proximity>();
...
//		setRetainInstance(true);
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.proximity_layout, null);
	...
	//	Relativelayout.setBackgroundResource(R.drawable.leaf);
		...
		proshow = (TextView) view.findViewById(R.id.show);

		if (proximity != null) {

			proshow.setText("名称：" + proximity.getName() + "\n\n版本："
					+ proximity.getVersion() + "\n\n供应商："
					+ proximity.getVendor() + "\n\n功率："
					+ proximity.getPower() + "\n\n分辨率："
					+ proximity.getResolution() + "\n\n最大范围："
	...
	public void onResume() {
		...
		sensor.registerListener(this, proximity, 500000);
	}
	...
	public void onSensorChanged(SensorEvent event) {
		...
		if (flag == 1) {
			...
			proshow.setText("接近传感器数据：\n\nx轴加速度：" + Double.parseDouble(df.format(x)) + "cm\n");
...
//			}	
	       ...
	       private String sample(double x){
				...
				String url = httpUtil.BASE_URL + "/ProximityServlet";
	...
	private void initView() {
		...
		mRenderer.setYTitle("数据(cm)");// 设置y轴的标题
