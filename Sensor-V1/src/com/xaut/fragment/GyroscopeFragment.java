...
import com.xaut.entity.Gyroscope;
...
public class GyroscopeFragment extends Fragment implements SensorEventListener {
	...
	private ArrayList<Gyroscope> list = new ArrayList<Gyroscope>();
...
//		setRetainInstance(true);
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.gyroscope_layout, null);
		...
		// 获取陀螺仪传感器实例
		gyroscope = sensor.getDefaultSensor(Sensor.TYPE_GYROSCOPE);
	...
	//	Relativelayout.setBackgroundResource(R.drawable.leaf);
		...
		gyrshow = (TextView) view.findViewById(R.id.show);

		if (gyroscope != null) {

			gyrshow.setText("名称：" + gyroscope.getName() + "\n\n版本："
	...
	public void onResume() {
		...
		sensor.registerListener(this, gyroscope, 500000);
	}
	...
	public void onSensorChanged(SensorEvent event) {
		...
		if (flag == 1) {
			...
			gyrshow.setText("陀螺仪传感器数据：\n\nx轴角速度：" + Double.parseDouble(df.format(x))
					+ "rad/s\n\ny轴角速度：" + Double.parseDouble(df.format(y))
					+ "rad/s\n\nz轴角速度：" + Double.parseDouble(df.format(z)) + "rad/s\n");
...
//			}	
    ...
    private String sample(double x, double y, double z){
		...
		String url = httpUtil.BASE_URL + "/GyroscopeServlet";
	...
	private void initView() {
		...
		mRenderer.setYTitle("数据(rad/s)");// 设置y轴的标题
