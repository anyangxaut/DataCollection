...
import com.xaut.entity.Gravity;
...
public class GravityFragment extends Fragment implements SensorEventListener{
	...
	private ArrayList<Gravity> list = new ArrayList<Gravity>();
...
//		setRetainInstance(true);
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.gravity_layout, null);

		// 从系统服务中获取传感器管理器
		sensor = (SensorManager) getActivity().getSystemService(Context.SENSOR_SERVICE);
		
		// 获取重力传感器实例
		gravity = sensor.getDefaultSensor(Sensor.TYPE_GRAVITY);
		...
		grashow = (TextView) view.findViewById(R.id.show);

		if (gravity != null) {
			
			grashow.setText("名称：" + gravity.getName()
					+ "\n\n版本：" + gravity.getVersion()
					+ "\n\n供应商：" + gravity.getVendor()
		        	+ "\n\n功率：" + gravity.getPower()
					+ "\n\n分辨率："
					+ gravity.getResolution()
					+ "\n\n最大范围："
					+ gravity.getMaximumRange() + "\n");
	...
	public void onResume() {
		...
		sensor.registerListener(this, gravity, 500000);
	}
...
//			}	
     ...
     private String sample(double x, double y, double z){
		...
		String url = httpUtil.BASE_URL + "/GravityServlet";
